...
|---|---|---|
| **macOS** Apple Silicon (13+) | `Lifeboat-2.2.41-macos-arm64.dmg` | **available** — Metal + MLX |
| **macOS** Intel (13+) | `Lifeboat-2.2.41-macos-x86_64.dmg` | **available** — GGUF only |
| **Linux** Debian/Ubuntu x64 | `lifeboat-desktop_2.2.41_amd64.deb` | **available** |
| **Linux** Debian/Ubuntu arm64 | `lifeboat-desktop_2.2.41_arm64.deb` | **available** |
| **Linux** any distro, x64 | `Lifeboat-2.2.41-linux-x86_64.tar.gz` | **available** |
| **Linux** any distro, arm64 | `Lifeboat-2.2.41-linux-aarch64.tar.gz` | **available** |
...
```sh
sudo dpkg -i lifeboat-desktop_2.2.41_amd64.deb
```

Any other distro — the tarball unpacks to the same layout, rooted at `/`:

```sh
sudo tar -C / -xzf Lifeboat-2.2.41-linux-x86_64.tar.gz
```
